...
/**
 * Created by Akhil on 19-04-2015.
 */
public class PhaserExample {
    void runTasks(List<Runnable> tasks) throws InterruptedException {

        /** The phaser is a nice synchronization main.barrier. */
        final Phaser phaser = new Phaser(1) {
            /**
             * onAdvance() is invoked when all threads reached the synchronization main.barrier. It returns true if the
        ...
        for (final Runnable task : tasks) {
            ...
            new Thread() {
                public void run() {
                    do {
                        /**
                         * Wait for all threads reaching the synchronization main.barrier: more precisely, wait for arrived
         ...
         * "face advances" means that all threads reached the main.barrier and therefore all threads are synchronized and can
         * continue processing.
         */
